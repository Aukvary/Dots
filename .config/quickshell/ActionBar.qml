...
PanelWindow {
    ...
    Rectangle {
        ...
        Row {
            ...
            Text { text: clockRow.t; color: "#cdd6f4"; font.family: "Google Sans"; font.pixelSize: 14; font.weight: Font.Medium; anchors.verticalCenter: parent.verticalCenter }
            Text { text: "|"; color: "#585b70"; font.family: "Google Sans"; font.pixelSize: 12; anchors.verticalCenter: parent.verticalCenter }
            Text { text: clockRow.d; color: "#cdd6f4"; font.family: "Google Sans"; font.pixelSize: 14; font.weight: Font.Medium; anchors.verticalCenter: parent.verticalCenter }
        }
    }
        ...
        RowLayout {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    color: foc ? "#cba6f7" : (occ ? "#585b70" : "#45475a")
                    border.width: 0
    ...
    Rectangle {
        ...
        Row {
            ...
            Item {
                ...
                Image {
                    ...
                    source: trayToggle._hov
                        ? "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23cdd6f4' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='m10 16 4-4-4-4'/><path d='M3 12h11'/><path d='M3 8V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3'/></svg>"
                        : "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23cdd6f4' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M10 12h11'/><path d='m17 16 4-4-4-4'/><path d='M21 6.344V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-1.344'/></svg>"
                }
                MouseArea {
            ...
            TrayPill { valueText: win.cpuPct+"%"; accentColor: "#cba6f7"
            ...
            TrayPill { valueText: win.ramGb.toFixed(1)+"G"; accentColor: "#a6e3a1"
                onClicked: win.statsVisible = !win.statsVisible
            ...
            TrayPill {
                ...
                accentColor: win.volMute ? "#f38ba8" : "#f5c2e7"
                iconSvg: {
