...
PanelWindow {
    ...
    // Background
    Rectangle { anchors.fill: parent; color: "#1e1e2e"; opacity: 0.97; radius: 14 }
    ...
    ColumnLayout {
        ...
        // ── Search bar ────────────────────────────────────────────────
        Rectangle {
            Layout.fillWidth: true; height: 44; radius: 10; color: "#313244"
            ...
            Row {
                ...
                Image {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    source: launcher.svg("<circle cx='11' cy='11' r='8'/><path d='m21 21-4.35-4.35'/>", "%236c7086", 16)
                }
                ...
                Repeater {
                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            ...
                            radius: 10
                            color: index === launcher.selIdx ? "#cba6f7" : (hov.containsMouse ? "#313244" : "transparent")
