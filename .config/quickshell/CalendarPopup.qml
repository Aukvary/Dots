...
PanelWindow {
    ...
    Item {
        ...
        Rectangle {
            anchors.fill: parent
            color: "#1e1e2e"; radius: 10
            Rectangle {
                anchors.top:   parent.top
                anchors.left:  parent.left
                anchors.right: parent.right
                height: 10; color: "#1e1e2e"
            }
        }
    }
    ...
    ColumnLayout {
        ...
        Rectangle {
            Layout.fillWidth: true; height: 80; radius: 8; color: "#313244"
            ...
            Text {
                ...
                color: "#cdd6f4"; font.family: "Google Sans"
            ...
            Text {
                ...
                text: cal.dateStr
                color: "#cba6f7"; font.family: "Google Sans"
                font.pixelSize: 17
            }
        }
        ...
        Rectangle {
            ...
            id: calCard
            height: 348; radius: 8; color: "#313244"
                ...
                RowLayout {
                    ...
                    Item { width: 28; height: 28
                        Text { anchors.centerIn: parent; text: "‹"
                            color: arL.containsMouse ? "#cdd6f4" : "#6c7086"
                    ...
                    Item { width: 28; height: 28
                        Text { anchors.centerIn: parent; text: "›"
                            color: arR.containsMouse ? "#cdd6f4" : "#6c7086"
                            font.pixelSize: 20; font.weight: Font.Medium
                            Behavior on color { ColorAnimation { duration: 80 } } }
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        Text {
                            ...
                            text: modelData
                            color: "#a6adc8"; font.family: "Google Sans"
                            font.pixelSize: 15; horizontalAlignment: Text.AlignHCenter
                        }
                    }
                }

                Rectangle { Layout.fillWidth: true; height: 1; color: "#45475a"; opacity: 0.3 }
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                color: isToday ? "#cba6f7" : (dMa.containsMouse && valid ? "#45475a" : "transparent")
                                Behavior on color { ColorAnimation { duration: 80 } }
                            }
