...
PanelWindow {
    ...
    // ── Background ────────────────────────────────────────────────────
    Rectangle { anchors.fill:parent; color:"#1e1e2e"; opacity:0.96; radius:8
        Rectangle { anchors.top:parent.top; anchors.left:parent.left; anchors.right:parent.right; height:8; color:"#1e1e2e" } }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    width:14; height:14; radius:3; color:"#45475a"
                    visible:avatMa.containsMouse
                    Image { anchors.centerIn:parent; width:9; height:9; smooth:true; source:cc.ico(cc.p_pencil,"%23cdd6f4",9) }
                }
                ...
                Rectangle {
                    ...
                    width:220; height:44; radius:8; color:"#313244"; z:10
            ...
            ColumnLayout { spacing:2; visible:!cc.editingName
                Text { text:cc.displayName||cc.hostname||"niriha"; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:15; font.weight:Font.Medium
                ...
                Text { text:"uptime "+(cc.uptime||""); color:"#a6adc8"; font.family:"Google Sans"; font.pixelSize:11; visible:cc.uptime!=="" }
            }
            Rectangle { visible:cc.editingName; height:28; width:120; radius:6; color:"#45475a"
                TextInput { id:nameEdit; anchors{fill:parent; leftMargin:8; rightMargin:8; verticalCenter:parent.verticalCenter}
                    color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:13; verticalAlignment:TextInput.AlignVCenter
            ...
            Rectangle {
                height: 38; radius: 8; color: "#313244"
                ...
                Row {
                    ...
                    Item { width: 36; height: 36
                        Rectangle { anchors.fill: parent; radius: 8; color: calMa.containsMouse ? "#45475a" : "transparent"
                            Behavior on color { ColorAnimation { duration: 80 } } }
                        Image { anchors.centerIn: parent; width: 16; height: 16; smooth: true
                            source: cc.ico(cc.p_cal, "%23cdd6f4", 16) }
                    ...
                    Rectangle { width: 1; height: 20; anchors.verticalCenter: parent.verticalCenter; color: "#45475a"; opacity: 0.5 }

                    Item { width: 36; height: 36
                        Rectangle { anchors.fill: parent; radius: 8; color: poMa.containsMouse ? "#452525" : "transparent"
                            Behavior on color { ColorAnimation { duration: 80 } } }
                        Image { anchors.centerIn: parent; width: 16; height: 16; smooth: true
                            source: cc.ico(cc.p_power, poMa.containsMouse ? "%23f38ba8" : "%23cdd6f4", 16) }
                    ...
                    Item { width: 36; height: 36
                        Rectangle { anchors.fill: parent; radius: 8; color: clMa.containsMouse ? "#45475a" : "transparent"
                            Behavior on color { ColorAnimation { duration: 80 } } }
                        Image { anchors.centerIn: parent; width: 16; height: 16; smooth: true
                            source: cc.ico(cc.p_x, clMa.containsMouse ? "%23f38ba8" : "%23cdd6f4", 16) }
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    RowLayout { anchors{fill:parent; margins:8}
                        spacing:10
                        Rectangle { width:36; height:36; radius:7; color:"#45475a"; Behavior on color{ColorAnimation{duration:150}}
                            Image{anchors.centerIn:parent; width:22; height:22; smooth:true; source:cc.ico(cc.p_wifi, "%23a6adc8", 22)} }
                        ColumnLayout { Layout.fillWidth:true; spacing:2; Layout.alignment:Qt.AlignVCenter
                            Text{text:"WiFi"; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:14; font.weight:Font.Medium; horizontalAlignment:Text.AlignHCenter; Layout.fillWidth:true}
                            Text{visible:cc.wifiOn&&cc.wifiName!==""; text:cc.wifiName; color:"#a6adc8"; font.family:"Google Sans"; font.pixelSize:12; elide:Text.ElideRight; Layout.fillWidth:true; horizontalAlignment:Text.AlignHCenter} }
                ...
                Rectangle {
                    ...
                    RowLayout { anchors{fill:parent; margins:8}
                        spacing:10
                        Rectangle { width:36; height:36; radius:7; color:"#45475a"; Behavior on color{ColorAnimation{duration:150}}
                            Image{anchors.centerIn:parent; width:22; height:22; smooth:true; source:cc.ico(cc.p_bt, "%23a6adc8", 22)} }
                        ColumnLayout { Layout.fillWidth:true; spacing:2; Layout.alignment:Qt.AlignVCenter
                            Text{text:"Bluetooth"; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:14; font.weight:Font.Medium; horizontalAlignment:Text.AlignHCenter; Layout.fillWidth:true}
                            Text{visible:cc.btOn&&cc.btDevice!==""; text:cc.btDevice; color:"#a6adc8"; font.family:"Google Sans"; font.pixelSize:12; elide:Text.ElideRight; Layout.fillWidth:true; horizontalAlignment:Text.AlignHCenter} }
            ...
            Item {
                ...
                Rectangle {
                    ...
                    width:44; height:parent.height; radius:10; color:"#313244"; clip:true
                    Rectangle {
                        ...
                        radius:10; color:cc.volMute?"#45475a":"#45475a"
                        Behavior on height{NumberAnimation{duration:120; easing.type:Easing.OutCubic}}
                        Behavior on color{ColorAnimation{duration:120}}
                    }
                    Text{anchors.horizontalCenter:parent.horizontalCenter; anchors.top:parent.top; anchors.topMargin:8
                        text:"VOL"; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:9; font.weight:Font.Bold; font.letterSpacing:1.5}
                    Text{anchors.horizontalCenter:parent.horizontalCenter; anchors.top:parent.top; anchors.topMargin:22
                        text:cc.volMute?"M":cc.volPct+"%"; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:13; font.weight:Font.Medium}
                    Image{anchors.horizontalCenter:parent.horizontalCenter; anchors.bottom:volFill.bottom; anchors.bottomMargin:8
                        ...
                        source:cc.ico(cc.volMute?cc.p_volX:cc.volPct<=30?cc.p_vol1:cc.volPct<=60?cc.p_vol2:cc.p_vol3, "%23a6adc8", 18)}
                }
            ...
            Item {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        radius:10; color:"#45475a"
                        Behavior on height{NumberAnimation{duration:120; easing.type:Easing.OutCubic}}
                    }
                    Text{anchors.horizontalCenter:parent.horizontalCenter; anchors.top:parent.top; anchors.topMargin:8
                        text:"BRI"; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:9; font.weight:Font.Bold; font.letterSpacing:1.5}
                    Text{anchors.horizontalCenter:parent.horizontalCenter; anchors.top:parent.top; anchors.topMargin:22
                        text:cc.briPct+"%"; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:13; font.weight:Font.Medium}
                    Image{anchors.horizontalCenter:parent.horizontalCenter; anchors.bottom:parent.bottom; anchors.bottomMargin:10
                        width:18; height:18; smooth:true
                        source:cc.ico(cc.briPct===0?cc.p_briOff:cc.p_bri, "%23a6adc8", 18)}
                }
        ...
        Column { Layout.fillWidth:true; visible:cc.wifiOpen&&cc.wifiNetworks.length>0; spacing:1
            Repeater { model:cc.wifiNetworks
                Rectangle { required property var modelData; width:mainCol.width; height:34; radius:6
                    color:wMa.containsMouse?"#313244":"transparent"; Behavior on color{ColorAnimation{duration:60}}
                    RowLayout{anchors{fill:parent; leftMargin:10; rightMargin:10}
                        ...
                        Row{spacing:2; Layout.alignment:Qt.AlignVCenter
                            Repeater{model:4; Rectangle{width:3; radius:1; height:4+index*3; anchors.bottom:parent.bottom
                                color:modelData.signal>=(index+1)*25?"#cba6f7":"#45475a"}}}
                        Text{text:modelData.ssid; Layout.fillWidth:true; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:13; elide:Text.ElideRight}
                        Image{visible:modelData.active; width:13; height:13; smooth:true; source:cc.ico(cc.p_check,"%23cba6f7",13)}}
        ...
        Column { Layout.fillWidth:true; visible:cc.btOpen; spacing:1
            Text{visible:cc.btDevices.length===0; text:"No devices connected"; color:"#a6adc8"; font.family:"Google Sans"; font.pixelSize:13; leftPadding:10}
            Repeater{model:cc.btDevices
                Rectangle{required property var modelData; width:mainCol.width; height:34; radius:6; color:"transparent"
                    RowLayout{anchors{fill:parent; leftMargin:10; rightMargin:10}
                        spacing:8
                        Image{width:15; height:15; smooth:true; source:cc.ico(cc.p_bt,"%23cba6f7",15)}
                        Text{text:modelData.name; Layout.fillWidth:true; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:13; elide:Text.ElideRight}
                        Text{text:"disconnect"; color:"#a6adc8"; font.family:"Google Sans"; font.pixelSize:12
        ...
        // ── ECG System Monitor ────────────────────────────────────────
        Rectangle {
            Layout.fillWidth:true; height:168; radius:10; color:"#313244"

            // subtle grid lines between rows
            Repeater { model:2
                Rectangle { x:10; y:56+index*54; width:parent.width-20; height:1; color:"#45475a"; opacity:0.25 } }
            ...
            Column {
                ...
                Item { width:parent.width; height:54
                    Rectangle { x:0; anchors.verticalCenter:parent.verticalCenter; width:36; height:36; radius:7; color:"#45475a";
                        Image { anchors.centerIn:parent; width:20; height:20; smooth:true; source:cc.ico(cc.p_cpu,"%23cdd6f4",20) }
                    }
                    Text { x:46; anchors.verticalCenter:parent.verticalCenter
                        text:Math.round(SystemStats.cpuPct)+"%"
                        color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:15; font.weight:Font.Medium; width:46 }
                    Canvas {
                        ...
                        onPaint: {
                            ...
                            ctx.strokeStyle="#cba6f7"; ctx.lineWidth=2; ctx.lineJoin="round"; ctx.beginPath()
                            ...
                            ctx.stroke()
                            ctx.fillStyle="#cba6f7"; ctx.beginPath()
                ...
                Item { width:parent.width; height:54
                    Rectangle { x:0; anchors.verticalCenter:parent.verticalCenter; width:36; height:36; radius:7; color:"#45475a";
                        Image { anchors.centerIn:parent; width:20; height:20; smooth:true; source:cc.ico(cc.p_therm,"%23cdd6f4",20) }
                    }
                    Text { x:46; anchors.verticalCenter:parent.verticalCenter
                    ...
                    Canvas {
                        ...
                        onPaint: {
                            var ctx=getContext("2d"); ctx.clearRect(0,0,width,height)
                            ctx.strokeStyle="#f9e2af"; ctx.lineWidth=2; ctx.lineJoin="round"; ctx.beginPath()
                            for(var i=0;i<hist.length;i++){
                                var px=i/(hist.length-1)*width
                                var py=height-(hist[i]/100)*height*0.85
                                i===0?ctx.moveTo(px,py):ctx.lineTo(px,py)
                            ...
                            ctx.stroke()
                            ctx.fillStyle="#f9e2af"; ctx.beginPath()
                            ctx.arc(width, height-(hist[hist.length-1]/100)*height*0.85, 3.5,0,Math.PI*2); ctx.fill()
                        }
                    }
                }
                ...
                Item { width:parent.width; height:54
                    Rectangle { x:0; anchors.verticalCenter:parent.verticalCenter; width:36; height:36; radius:7; color:"#45475a";
                        Image { anchors.centerIn:parent; width:20; height:20; smooth:true; source:cc.ico(cc.p_ram,"%23cdd6f4",20) }
                    }
                    Text { x:46; anchors.verticalCenter:parent.verticalCenter
                    ...
                    Canvas {
                        ...
                        onPaint: {
                            var ctx=getContext("2d"); ctx.clearRect(0,0,width,height)
                            ctx.strokeStyle="#f5c2e7"; ctx.lineWidth=2; ctx.lineJoin="round"; ctx.beginPath()
                            for(var i=0;i<hist.length;i++){
                                var px=i/(hist.length-1)*width
                                var py=height-(hist[i]/100)*height*0.85
                                i===0?ctx.moveTo(px,py):ctx.lineTo(px,py)
                            ...
                            ctx.stroke()
                            ctx.fillStyle="#f5c2e7"; ctx.beginPath()
                            ctx.arc(width, height-(hist[hist.length-1]/100)*height*0.85, 3.5,0,Math.PI*2); ctx.fill()
                        }
                    }
                }
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                // Big album art
                Rectangle { width:92; height:92; radius:8; color:"#45475a"; clip:true
                    Image {
                        anchors.fill:parent
                    ...
                    Image { anchors.centerIn:parent; width:28; height:28; smooth:true
                        ...
                        source: cc.ico(cc.p_music,"%236c7086",28) }
                }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Item { width:40; height:40
                            Rectangle { anchors.fill:parent; radius:20; color:sbMa.containsMouse?"#45475a":"transparent"
                                Behavior on color { ColorAnimation { duration:80 } } }
                            Image { anchors.centerIn:parent; width:18; height:18; smooth:true
                                source:cc.ico(cc.p_skipB,"%23a6adc8",18) }
                        ...
                        Item { width:52; height:52
                            Rectangle { anchors.fill:parent; radius:26; color:"#45475a"
                                Behavior on color { ColorAnimation { duration:80 } } }
                            Image { anchors.centerIn:parent; width:22; height:22; smooth:true
                                source: cc.ico(cc.player&&cc.player.isPlaying?cc.p_pause:cc.p_play,"%23cdd6f4",22) }
                            MouseArea { anchors.fill:parent; cursorShape:Qt.PointingHandCursor
                                onClicked: if(cc.player) cc.player.togglePlaying() } }

                        // skip fwd
                        Item { width:40; height:40
                            Rectangle { anchors.fill:parent; radius:20; color:sfMa.containsMouse?"#45475a":"transparent"
                                Behavior on color { ColorAnimation { duration:80 } } }
                            Image { anchors.centerIn:parent; width:18; height:18; smooth:true
                                source:cc.ico(cc.p_skipF,"%23a6adc8",18) }
                    ...
                    RowLayout {
                        ...
                        Item { width:32; height:32
                            Image { anchors.centerIn:parent; width:16; height:16; smooth:true
                                source:cc.ico(cc.p_shuf,"%236c7086",16) }
                            MouseArea { anchors.fill:parent; cursorShape:Qt.PointingHandCursor } }
                        Item { width:32; height:32
                            Image { anchors.centerIn:parent; width:16; height:16; smooth:true
                                source:cc.ico(cc.p_repeat,"%236c7086",16) }
                            MouseArea { anchors.fill:parent; cursorShape:Qt.PointingHandCursor } }
                        Item { Layout.fillWidth:true }
                    }
                }
            ...
            ColumnLayout {
                ...
                Text {
                    ...
                    color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:16; font.weight:Font.Medium
                    Layout.fillWidth:true; elide:Text.ElideRight
                }
                Text {
                    text: cc.player ? ((cc.player.trackArtist||"") + (cc.player.trackAlbum ? " · " + cc.player.trackAlbum : "")) : ""
                    color:"#a6adc8"; font.family:"Google Sans"; font.pixelSize:13
                ...
                Item { Layout.fillWidth:true; height:20
                    Text { anchors.left:parent.left; anchors.verticalCenter:parent.verticalCenter
                        ...
                        color:"#6c7086"; font.family:"Google Sans"; font.pixelSize:11 }
                    Text { anchors.right:parent.right; anchors.verticalCenter:parent.verticalCenter
                        ...
                        color:"#6c7086"; font.family:"Google Sans"; font.pixelSize:11 }
                    Rectangle { anchors.centerIn:parent; width:parent.width-56; height:6; radius:3; color:"#45475a"
                        Rectangle {
