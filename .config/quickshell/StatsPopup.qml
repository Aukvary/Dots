...
PanelWindow {
    ...
    Item { anchors.fill:parent; opacity:0.96
        Rectangle { anchors.fill:parent; color:"#1e1e2e"; radius:10
            Rectangle { anchors.top:parent.top; anchors.left:parent.left; anchors.right:parent.right; height:10; color:"#1e1e2e" }
        }
    }
    ...
    ColumnLayout {
        ...
        // ── ECG ───────────────────────────────────────────────────────
        Rectangle { Layout.fillWidth:true; height:168; radius:10; color:"#313244"
            Repeater { model:2; Rectangle { x:10; y:56+index*54; width:parent.width-20; height:1; color:"#45475a"; opacity:0.25 } }
            Column {
                anchors.left:      parent.left
                anchors.right:     parent.right
                anchors.top:       parent.top
                ...
                Item { width:parent.width; height:54
                    Rectangle{x:0;anchors.verticalCenter:parent.verticalCenter;width:30;height:30;radius:6;color:"#45475a"
                        Image{anchors.centerIn:parent;width:16;height:16;smooth:true;source:sp.ico(sp.i_cpu,"%23cdd6f4",16)}}
                    Text{x:40;anchors.verticalCenter:parent.verticalCenter;text:Math.round(SystemStats.cpuPct)+"%";color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:15;font.weight:Font.Medium;width:46}
                    Canvas{x:88;y:7;width:parent.width-88;height:40;property var hist:sp.cpuHist;onHistChanged:requestPaint()
                        onPaint:{var c=getContext("2d");c.clearRect(0,0,width,height);c.strokeStyle="#cba6f7";c.lineWidth=1.8;c.lineJoin="round";c.beginPath();for(var i=0;i<hist.length;i++){var px=i/(hist.length-1)*width,py=height-(hist[i]/100)*height*.85;i?c.lineTo(px,py):c.moveTo(px,py)}c.stroke();c.fillStyle="#cba6f7";c.beginPath();c.arc(width,height-(hist[hist.length-1]/100)*height*.85,3,0,Math.PI*2);c.fill()}}
                }
                Item { width:parent.width; height:54
                    Rectangle{x:0;anchors.verticalCenter:parent.verticalCenter;width:30;height:30;radius:6;color:"#45475a"
                        Image{anchors.centerIn:parent;width:16;height:16;smooth:true;source:sp.ico(sp.i_therm,"%23cdd6f4",16)}}
                    Text{x:40;anchors.verticalCenter:parent.verticalCenter;text:SystemStats.cpuTemp>0?Math.round(SystemStats.cpuTemp)+"°":"--°";color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:15;font.weight:Font.Medium;width:46}
                    Canvas{x:88;y:7;width:parent.width-88;height:40;property var hist:sp.tempHist;onHistChanged:requestPaint()
                        onPaint:{var c=getContext("2d");c.clearRect(0,0,width,height);c.strokeStyle="#f9e2af";c.lineWidth=1.8;c.lineJoin="round";c.beginPath();for(var i=0;i<hist.length;i++){var px=i/(hist.length-1)*width,py=height-(hist[i]/100)*height*.85;i?c.lineTo(px,py):c.moveTo(px,py)}c.stroke();c.fillStyle="#f9e2af";c.beginPath();c.arc(width,height-(hist[hist.length-1]/100)*height*.85,3,0,Math.PI*2);c.fill()}}
                }
                Item { width:parent.width; height:54
                    Rectangle{x:0;anchors.verticalCenter:parent.verticalCenter;width:30;height:30;radius:6;color:"#45475a"
                        Image{anchors.centerIn:parent;width:16;height:16;smooth:true;source:sp.ico(sp.i_ram,"%23cdd6f4",16)}}
                    Text{x:40;anchors.verticalCenter:parent.verticalCenter;text:SystemStats.ramGb.toFixed(1)+"G";color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:15;font.weight:Font.Medium;width:46}
                    Canvas{x:88;y:7;width:parent.width-88;height:40;property var hist:sp.ramHist;onHistChanged:requestPaint()
                        onPaint:{var c=getContext("2d");c.clearRect(0,0,width,height);c.strokeStyle="#f5c2e7";c.lineWidth=1.8;c.lineJoin="round";c.beginPath();for(var i=0;i<hist.length;i++){var px=i/(hist.length-1)*width,py=height-(hist[i]/100)*height*.85;i?c.lineTo(px,py):c.moveTo(px,py)}c.stroke();c.fillStyle="#f5c2e7";c.beginPath();c.arc(width,height-(hist[hist.length-1]/100)*height*.85,3,0,Math.PI*2);c.fill()}}
                }
            }
        }

        // ── Network ───────────────────────────────────────────────────
        Rectangle { Layout.fillWidth:true; height:64; radius:10; color:"#313244"
            Item {
                anchors.fill: parent
                ...
                Column {
                    ...
                    spacing: 3
                    Row { spacing:6
                        Image{width:14;height:14;smooth:true;anchors.verticalCenter:parent.verticalCenter;source:sp.ico(sp.i_down,"%23a6e3a1",14)}
                        Text{text:sp.fmtNet(sp.rxKb);color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:16;font.weight:Font.Medium;anchors.verticalCenter:parent.verticalCenter}
                    }
                    Text{text:"Download";color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:10}
                }

                // Separator
                Rectangle { width:1; height:40; color:"#45475a"; opacity:0.4; anchors.centerIn:parent }
                ...
                Column {
                    ...
                    Row { spacing:6; layoutDirection:Qt.RightToLeft
                        Image{width:14;height:14;smooth:true;anchors.verticalCenter:parent.verticalCenter;source:sp.ico(sp.i_up,"%23fab387",14)}
                        Text{text:sp.fmtNet(sp.txKb);color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:16;font.weight:Font.Medium;anchors.verticalCenter:parent.verticalCenter}
                    }
                    Text{text:"Upload";color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:11;anchors.right:parent.right}
                }
            }
        }
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                Layout.fillWidth: true; height: 62; radius: 10; color: "#313244"
                Item {
                    anchors.fill: parent
                    ...
                    Row {
                        ...
                        Image { width:13; height:13; smooth:true; anchors.verticalCenter:parent.verticalCenter
                            source: sp.ico(sp.i_disk, "%23a6adc8", 13) }
                        Text { text: modelData.mount; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:13; font.weight:Font.Medium; anchors.verticalCenter:parent.verticalCenter }
                        Item { width:1; height:1; Layout.fillWidth:true }
                        Text { text: modelData.used+" / "+modelData.total; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:12; anchors.verticalCenter:parent.verticalCenter }
                    }
                    ...
                    Rectangle {
                        ...
                        anchors.left: parent.left
                        anchors.right: parent.right
                        height: 6; radius: 3; color: "#45475a"
                        Rectangle {
                            width: parent.width * Math.min(modelData.pct, 100) / 100
                            height: parent.height; radius: 3; color: "#a6adc8"
                        ...
                        Text { anchors.right:parent.right; anchors.rightMargin:4; anchors.verticalCenter:parent.verticalCenter
                            text: modelData.pct+"%"; color:"#cdd6f4"; font.family:"Google Sans"; font.pixelSize:10; font.weight:Font.Bold }
                    }
                }
            }
        }
        ...
        // ── Load avg ──────────────────────────────────────────────────
        Rectangle { Layout.fillWidth:true; height:58; radius:10; color:"#313244"
            Item {
                anchors.fill: parent
                anchors.leftMargin: 14
                anchors.rightMargin: 14
                ...
                Column {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    spacing: 4
                    Text{text:"Load Average";color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:10}
                    Row { spacing:14
                        Column { spacing:1
                            Text{text:sp.loadAvg1.toFixed(2);color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:16;font.weight:Font.Medium}
                            Text{text:"1 min";color:"#a6adc8";font.family:"Google Sans";font.pixelSize:10}
                        }
                        Column { spacing:1
                            Text{text:sp.loadAvg5.toFixed(2);color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:16}
                            Text{text:"5 min";color:"#a6adc8";font.family:"Google Sans";font.pixelSize:10}
                        }
                        Column { spacing:1
                            Text{text:sp.loadAvg15.toFixed(2);color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:16}
                            Text{text:"15 min";color:"#a6adc8";font.family:"Google Sans";font.pixelSize:10}
                        }
                    }
                }
                ...
                Column {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    spacing: 4
                    Text{text:"Uptime";color:"#6c7086";font.family:"Google Sans";font.pixelSize:11;anchors.right:parent.right}
                    Text{text:sp.uptimeStr||"";color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:16;font.weight:Font.Medium}
                }
            }
        }

        // ── Host ──────────────────────────────────────────────────────
        Rectangle { Layout.fillWidth:true; height:62; radius:10; color:"#313244"
            Item {
                anchors.fill: parent
                anchors.leftMargin: 14
                anchors.rightMargin: 14
                ...
                Column {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    spacing: 3
                    Text{text:sp.hostname||"";color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:16;font.weight:Font.Medium}
                    Text{text:sp.osName||"Linux";color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:13}
                }
                ...
                Column {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    spacing: 3
                    Text{text:"Kernel";color:"#6c7086";font.family:"Google Sans";font.pixelSize:11;anchors.right:parent.right}
                    Text{text:sp.kernelVer||"";color:"#cdd6f4";font.family:"Google Sans";font.pixelSize:15;font.weight:Font.Medium}
                }
            }
        }
    }
